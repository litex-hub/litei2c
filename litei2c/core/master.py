...
class LiteI2CMaster(LiteXModule):
    ...
    def __init__(self, tx_fifo_depth=1, rx_fifo_depth=1):
        ...
        # FIFOs.
        self.tx_fifo = tx_fifo = stream.SyncFIFO(i2c_core2phy_layout, depth=tx_fifo_depth)
        self.rx_fifo = rx_fifo = stream.SyncFIFO(i2c_phy2core_layout, depth=rx_fifo_depth)
